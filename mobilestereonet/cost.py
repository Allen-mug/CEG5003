...
with torch.cuda.device(0):
    ...
    num_ops = np.round(macs2D / 1000000000, 5)
    num_params = np.round(params2D / 1000000, 5)
    macs3D, params3D = profile(__models__['MSNet3D'](192), inputs=(L, R))

    print("==========================\n", '2D-MobileStereoNet', "\n==========================")
    # print('{:<30}  {:<8} * 1e+9'.format('Number of operations: ', np.round(macs2D / 1000000000, 5)))
    # print('{:<30}  {:<8} * 1e+6'.format('Number of parameters: ', np.round(params2D / 1000000, 5)))

    print('{:<30}  {:<8} * 1e+9'.format('Number of operations: ', num_ops))
    print('{:<30}  {:<8} * 1e+6'.format('Number of parameters: ', num_params))

    # model_name = 'Original Model'
    # with open('/home/tlab4/cj/data_mvsec/cost.txt', 'a') as f:
    #     f.writelines(model_name + ':\n')
    #     f.writelines('Numer of operations: {}       Numer of parameters: {} \n\n'.format(num_ops, num_params))
